...
def level0_market():
    ...
    demand = Demand(
        ...
        properties = {
            ...
            "golem.srv.comp.expiration": int((datetime.now() + timedelta(days=1)).timestamp() * 1000),
    ...
    time.sleep(2.) # TODO: collect_offers should wait
    # COLLECT OFFERS
    ...
    agreement_proposal = AgreementProposal(
        proposal_id = counterProposal.proposal_id,
        valid_to =valid_to
    )
